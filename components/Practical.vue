<template>
  <section
    class="z-10 relative w-7/12 m-auto flex flex-col justify-center items-center"
    id="practical"
  >
    <h2 class="text-6xl font-bold text-center mt-10 mb-20 text-white">
      Praktisch
    </h2>
    <ul class="flex flex-wrap justify-between w-full  sm:flex-col sm:gap-10 md:flex-col gap-10 lg:flex-row xl:flex-row">
      ...
      <li class="flex flex-col items-center justify-center">
        ...
        <p class="text-xl">Grote Markt</p>
        <p class="text-lg">Izegem</p>
      </li>
      <li class="flex flex-col items-center justify-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
